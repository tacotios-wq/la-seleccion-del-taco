...
const STEPS = [
  {
    num: "01",
    title: "Vota",
    desc: "Cada semana hay un enfrentamiento. Dos taquer\u00edas, un voto. T\u00fa decides qui\u00e9n avanza a la siguiente ronda.",
  },
  {
    num: "02",
    title: "Visita",
    desc: "Ve a las taquer\u00edas, prueba los tacos. Tu voto pesa m\u00e1s si verificas que estuviste ah\u00ed.",
  },
  {
    num: "03",
    title: "Colecciona",
    desc: "Cada visita te da un sello en tu pasaporte taquero. Completa la colecci\u00f3n de los 16 participantes.",
  },
  {
    num: "04",
    title: "Descubre",
    desc: "Explora el mapa con todas las taquer\u00edas seleccionadas. Filtra por tipo de taco, zona o precio.",
  },
  {
    num: "05",
    title: "Comparte",
    desc: "Comparte tus matchups favoritos, presume tu pasaporte, reta a tus amigos a coleccionar m\u00e1s sellos.",
  },
];
